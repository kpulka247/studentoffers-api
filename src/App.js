...
export default function App() {
    ...
    return (
        <div
            ...
            <div className='bg-1 top-1/4 left-2/4'/>
            <div className='bg-1 bottom-3/4 right-1/4'/>
            <div className='bg-2 bottom-2/3 left-1/2'/>
            <div className='bg-2 bottom-1/4 left-1/4'/>
            <div className='bg-1 top-2/4 right-2/4'/>
            <div className='bg-1 top-1/3 left-1/4'/>
            <div className='bg-1 top-1/2 right-1/4'/>
            <div className='bg-2 bottom-0 right-1/3'/>
            <div className='bg-1 bottom-0 right-1/2'/>
            <Router>
                <AuthProvider>
                    <Header/>
                    <Suspense fallback={
